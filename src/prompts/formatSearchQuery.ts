...
export const AnswerQueryFromSearchPrompt: CustomChatRequestMessage = 
    {
        role: 'system',
        content: `
        You are tasked with responding to a user query within a pharmacy knowledge environment. 
        ...
        Your goal is to answer the query using relevant information from these contracts. 
